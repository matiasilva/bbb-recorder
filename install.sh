...
export BBB_RECORDER_DOWNLOAD_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" >/dev/null 2>&1 && pwd )"
envsubst < ./snippets/post_publish_bbb_recorder.rb.template > /usr/local/bigbluebutton/core/scripts/post_publish/post_publish_bbb_recorder.rb

# change ownership
chown bigbluebutton:bigbluebutton /usr/local/bigbluebutton/core/scripts/post_publish/post_publish_bbb_recorder.rb
